                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" value="{{ old('nama') }}" placeholder="Nama Layanan">
                            @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                                name="harga" value="{{ old('harga') }}" placeholder="Harga layanan" min="0"
                                step="1000">
                            @error('harga')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('durasi') is-invalid @enderror" id="durasi"
                                name="durasi" value="{{ old('durasi') }}" placeholder="Durasi pengerjaan dalam menit"
                                min="1">
                            @error('durasi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
