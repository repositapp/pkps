                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nomor_sambungan') is-invalid @enderror"
                                id="nomor_sambungan" name="nomor_sambungan" value="{{ old('nomor_sambungan') }}"
                                placeholder="Nomor Sambungan (Opsional saat pendaftaran)">
                            @error('nomor_sambungan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Akan diisi otomatis setelah pemasangan disetujui.</small>
                        </div>
                    </div>
