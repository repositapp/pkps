...
@section('content')
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('tahunajaran.update', $tahunAjaran->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_ajaran', $tahunAjaran->tahun_ajaran) }}" placeholder="2023/2024">
