<!-- resources/views/mobile/guru/perilaku/pilih-kelas.blade.php -->
    ...
    @else
        <div class="space-y-3">
            @foreach ($kelasList as $kelas)
                <a href="{{ route('mobile.guru.perilaku.create', $kelas->id) }}"
                    ...
                    <div class="text-gray-600 text-sm">Klik untuk catat perilaku</div>
                </a>
            @endforeach
        </div>
    @endif
