    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Form Tambah Permohonan Pemasangan</h3>
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('pemasangan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3"
                                placeholder="Deskripsikan tujuan pemasangan..." required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tanggal_permohonan', date('Y-m-d')) }}" placeholder="yyyy-mm-dd"
                                    required>
                            </div>
