    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Form Tambah Pengaduan</h3>
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('pengaduan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="4"
                                placeholder="Jelaskan detail pengaduan..." required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
