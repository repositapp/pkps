                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('role') is-invalid @enderror" id="role" name="role">
                                ...
                                <option value="admin_komunitas"
                                    @if (old('role') == 'admin_komunitas') selected="selected" @endif>Admin Komunitas
                                </option>
                                <option value="admin_barber" @if (old('role') == 'admin_barber') selected="selected" @endif>
                                    Admin Barber
                                </option>
                                <option value="pelanggan" @if (old('role') == 'pelanggan') selected="selected" @endif>
                                    Pelanggan</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">
