                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('role') is-invalid @enderror" id="role" name="role">
                                ...
                                <option value="admin_komunitas"
                                    @if (old('role', $user->role) == 'admin_komunitas') selected="selected" @endif>Admin Komunitas
                                </option>
                                <option value="admin_barber" @if (old('role', $user->role) == 'admin_barber') selected="selected" @endif>
                                    Admin Barber</option>
                                <option value="pelanggan" @if (old('role', $user->role) == 'pelanggan') selected="selected" @endif>
                                    Pelanggan</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-10">
                            ...
                            @if ($user->avatar)
                                ...
                                <img src="{{ asset('storage/' . $user->avatar) }}"
                                    class="img-thumbnail img-fluid mb-3 col-sm-2 d-block" alt="User Image">
                            @else
