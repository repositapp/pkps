    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Form Edit Tagihan</h3>
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="{{ route('tagihan.update', $tagihan->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('periode', \Carbon\Carbon::parse($tagihan->periode)->translatedFormat('Y-m')) }}"
                                    required placeholder="yyyy-mm">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('meter_awal') is-invalid @enderror"
                                id="meter_awal" name="meter_awal" value="{{ old('meter_awal', $tagihan->meter_awal) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('meter_akhir') is-invalid @enderror"
                                id="meter_akhir" name="meter_akhir" value="{{ old('meter_akhir', $tagihan->meter_akhir) }}"
                                placeholder="0" min="0" required>
                            @error('meter_akhir')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" step="0.01"
                                ...
                                value="{{ old('biaya_administrasi', $tagihan->biaya_administrasi) }}" placeholder="0.00"
                                min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('status_pembayaran') is-invalid @enderror"
                                ...
                                <option value="0"
                                    {{ old('status_pembayaran', $tagihan->status_pembayaran) == '0' ? 'selected' : '' }}>
                                    Belum Lunas</option>
                                <option value="1"
                                    {{ old('status_pembayaran', $tagihan->status_pembayaran) == '1' ? 'selected' : '' }}>
                                    Lunas</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('pembaca_meter') is-invalid @enderror"
                                id="pembaca_meter" name="pembaca_meter"
                                value="{{ old('pembaca_meter', $tagihan->pembaca_meter) }}"
